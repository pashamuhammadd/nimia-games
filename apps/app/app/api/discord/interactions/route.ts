...
// full URL (https://app.nimiastudio.com/api/discord/interactions) as the
      ...
      embeds: [
        {
          ...
          description:
            "This Discord account isn't linked to a Nimia Studio account yet. Log in at app.nimiastudio.com, go to **Profile → Connect Discord**, then come back and click the button again.",
          color: 0xf5a623,
        },
      ],
    });
