...
// Unchanged from apps/studio/app/components/dashboard/ComingSoonState.tsx —
// the shared "this section's backend doesn't exist yet" placeholder,
// reused here for Clients/Projects/Invoices/Services (v1 scope agreed:
// Overview + Orders are fully live, the rest come later).
