...
export default async function HomePage() {
  ...
  const [{ count: orderCount }, { data: recentOrders }, { data: partner }] = await Promise.all([
    client
  ...
  const { data: metricsRows } = partner
    ? await supabase
        .rpc("get_partner_metrics", { p_partner_id: partner.id })
        .returns<{ available_reward_usd: number }[]>()
    : { data: null };
