// Site-wide structured data for studio.nimiagames.com (SEO fix, 10 Agustus
...
// "https://studio.nimiagames.com") — so search engines can connect the two
...
export function JsonLd() {
  const organizationSchema = {
    ...
    logo: "https://studio.nimiagames.com/nimia-mark-hero.png",
    image: "https://studio.nimiagames.com/og-image.png",
    description:
