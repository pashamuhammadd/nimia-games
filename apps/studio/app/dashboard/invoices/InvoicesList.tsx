...
// placeholder. Every row is a genuinely paid & verified order
// (status='paid'); the actual PDF is generated by the existing
// GET /api/orders/[id]/receipt route (packages/db/migrations/
// 0024_order_receipts.sql -> get_or_create_order_receipt), same endpoint
// PaymentPanel.tsx's per-order "Download Receipt" button already used —
// this is just the first place that lists every one of them in one view.
